...
class Hero(object):
    ...
    def __init__(self, baseHealth, baseStamina, baseInt, baseArmor, attack, agility):
        ...
        '''
        MICHAEL CHANGES: Not sure what these are, commenting out to add back in if necessary
        self.armor_inv = {}
        self.weapon_inv = {}
        self.items_inv = {}
        '''
    ...
    def check_level(self):
        ...
        if self.level < level_by_xp:
            ...
            items.use_item(self.item_worn, self)
    ...
    def __str__(self):
        string = "%s\n" \
                 ...
                 "Experience: %d\n" \
                 "Level: %d\n" \
                 % (self.hero_type, self.curHealth, self.totalHealth(),
                 self.curStamina, self.totalStamina(),
                 self.curInt, self.totalIntelligence(),
